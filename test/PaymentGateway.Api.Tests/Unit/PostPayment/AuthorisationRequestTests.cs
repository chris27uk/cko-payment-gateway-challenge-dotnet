...
namespace PaymentGateway.Api.Tests.Unit.PostPayment
{
    public class AuthorisationRequestTests
    {
        ...
        public void Given_A_Valid_Authorisation_Request_When_Sending_To_Acquiring_Bank_Then_Expiry_Date_Is_Correct(int expiryMonth, int expiryYear, string expectedExpiryDate)
        {
        ...
        [Fact]
        public void Given_A_Valid_Authorisation_Request_When_Sending_To_Acquiring_Bank_Then_Card_Number_Is_Correct()
        {
        ...
        [Fact]
        public void Given_A_Valid_Authorisation_Request_When_Sending_To_Acquiring_Bank_Then_Amount_Is_Correct()
        {
        ...
        [Fact]
        public void Given_A_Valid_Authorisation_Request_When_Sending_To_Acquiring_Bank_Then_Currency_Is_Correct()
        {
        ...
        [InlineData(345)]
        [InlineData(3456)]
        public void Given_A_Valid_Authorisation_Request_When_Sending_To_Acquiring_Bank_Then_Cvv_Is_Correct(int expectedCvv)
        {
