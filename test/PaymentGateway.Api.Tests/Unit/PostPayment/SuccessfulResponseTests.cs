...
namespace PaymentGateway.Api.Tests.Unit.PostPayment
{
    ...
    {
        [Fact]
        public void Given_A_Valid_Payment_When_Creating_A_Payment_Then_Saves_Correct_Expiry_Month()
        {
        ...
        [Fact]
        public void Given_A_Valid_Payment_When_Creating_A_Payment_Then_Returns_Correct_Expiry_Year()
        {
        ...
        [Fact]
        public void Given_A_Valid_Payment_When_Creating_A_Payment_Then_Returns_Correct_Authorisation_Amount()
        {
        ...
        [Fact]
        public void Given_A_Valid_Payment_When_Creating_A_Payment_Then_Returns_Correct_Last_Four_Digits()
        {
        ...
        [Fact]
        public void Given_A_Valid_Payment_When_Creating_A_Payment_Then_Returns_Correct_Currency()
        {
        ...
        [Fact]
        public void Given_A_Valid_Payment_When_Creating_A_Payment_Then_Returns_Correct_Authorisation_Code()
        {
        ...
        [Fact]
        public void Given_A_Valid_Payment_That_Will_Authorise_When_Creating_A_Payment_Then_Returns_Payment_Status()
        {
            var payment = Payments.CreatePaymentToBeSaved();
        ...
        [Fact]
        public void Given_A_Valid_Payment_That_Will_Decline_When_Creating_A_Payment_Then_Returns_Payment_Status()
        {
            var payment = Payments.CreatePaymentToBeSaved();
